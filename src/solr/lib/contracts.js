...
import SolrAbi from './abi/solr.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.solr = new this.web3.eth.Contract(SolrAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.solr, contractAddresses.solr[networkId])
  ...
  setDefaultAccount(account) {
    this.solr.options.from = account

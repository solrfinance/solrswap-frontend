    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Solr protocol have made
      ...
      return (
        <div>
          <p>Attention SOLR Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with SOLR is SOLR/yCRV
            (Curve yPool tokens)
          </p>
